...
void create_board_layout(VerticalLayout layout) {
    ...
    ninthLine.addChild(new HSpacer().layoutWidth(50));
    ninthLine.addChild(new HSpacer().layoutWidth(50));
    ninthLine.addChild(createBoardImageButton("gray23", "gray_board_piece.png"));
    ninthLine.addChild(createBoardImageButton("blue_end_3", "blue_board_piece.png"));
    ninthLine.addChild(createBoardImageButton("gray16", "gray_board_piece.png"));
    ninthLine.addChild(
