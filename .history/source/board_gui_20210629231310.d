...
ImageButton createBoardImageButton(string id, ) {
...
void create_board_layout(VerticalLayout layout) {
    ...
    ImageButton yellow_base_1 = new ImageButton("yellow_base_1", "yellow_board_piece.png");
    yellow_base_1.layoutWidth(50).layoutHeight(50).padding(Rect(0, 0, 0, 0)).margins(Rect(0, 0, 0, 0));
    yellow_base_1.click = delegate(Widget src) {
        Log.i("Button " ~ yellow_base_1.id ~ " clicked");
        return true;
    };
    firstLine.addChild(yellow_base_1);
    firstLine.addChild(
