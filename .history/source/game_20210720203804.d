...
class MainMenu : VerticalLayout {
    ...
    this() {
        ...
        // addChild(new Button(ACTION_READY));
    }

    void setTotalPlayers(int diceResult) {
        _totalPlayers.text = toUTF32(to!string(diceResult));
    }

    void setReadyPlayers(dstring currentPlayer) {
        _readyPlayers.text = toUTF32(currentPlayer);
    }
