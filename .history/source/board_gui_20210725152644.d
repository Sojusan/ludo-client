    ...
    public:
        ...
        ImageButton createBoardImageButton(string id, string image) {
            ...
            button.click = delegate(Widget src) {
                ...
                _callback.onBoardPieceClick(button.id);
                return true;
            };

            /// ZROOBIĆ ŻEBY DZIAŁAŁO KLIKANIE W POLA NA PLANSZY, W JAKI SPOSÓB MA TO SIĘ ŁACZYĆ
            /// WŁAŚCWIE TO SĄ POLA W GAME PANELU WIĘC CHYBA JEST DOSTĘP DO TEGO

            // button.action = BOARD_FIELD_CLICKED;
            return button;
        }
        ...
        void create_board_layout(VerticalLayout layout) {
            ...
            sixthLine.addChild(createBoardField(BoardFields.RED_END_2[0], BoardFields.RED_END_2[1]));
            sixthLine.addChild(createBoardField(BoardFields.RED_END_1[0], BoardFields.RED_END_1[1]));
            ...
            seventhLine.addChild(createBoardField(BoardFields.BLUE_END_4[0], BoardFields.BLUE_END_4[1]));
            ...
            seventhLine.addChild(createBoardField(BoardFields.RED_START[0], BoardFields.RED_START[1]));
            // Eighth line
            ...
            eighthLine.addChild(createBoardField(BoardFields.BLUE_END_3[0], BoardFields.BLUE_END_3[1]));
            ...
            ninthLine.addChild(createBoardField(BoardFields.BLUE_END_2[0], BoardFields.BLUE_END_2[1]));
            ...
            tenthLine.addChild(createBoardField(BoardFields.BLUE_BASE_1[0], BoardFields.BLUE_BASE_1[1]));
            tenthLine.addChild(createBoardField(BoardFields.BLUE_BASE_2[0], BoardFields.BLUE_BASE_2[1]));
            ...
            tenthLine.addChild(createBoardField(BoardFields.BLUE_END_1[0], BoardFields.BLUE_END_1[1]));
            tenthLine.addChild(createBoardField(BoardFields.GRAY_18[0], BoardFields.GRAY_18[1]));
            tenthLine.addChild(new HSpacer().layoutWidth(50));
            tenthLine.addChild(new HSpacer().layoutWidth(50));
            tenthLine.addChild(createBoardField(BoardFields.RED_BASE_1[0], BoardFields.RED_BASE_1[1]));
            tenthLine.addChild(createBoardField(BoardFields.RED_BASE_2[0], BoardFields.RED_BASE_2[1]));
            // Eleventh line
            HorizontalLayout eleventhLine = new HorizontalLayout(BoardLines.ELEVENTH_LINE);
            eleventhLine.addChild(createBoardField(BoardFields.BLUE_BASE_3[0], BoardFields.BLUE_BASE_3[1]));
            eleventhLine.addChild(createBoardField(BoardFields.BLUE_BASE_4[0], BoardFields.BLUE_BASE_4[1]));
            eleventhLine.addChild(new HSpacer().layoutWidth(50));
            eleventhLine.addChild(new HSpacer().layoutWidth(50));
            eleventhLine.addChild(createBoardField(BoardFields.BLUE_START[0], BoardFields.BLUE_START[1]));
            ...
            eleventhLine.addChild(new HSpacer().layoutWidth(50));
            eleventhLine.addChild(new HSpacer().layoutWidth(50));
            eleventhLine.addChild(createBoardField(BoardFields.RED_BASE_3[0], BoardFields.RED_BASE_3[1]));
            eleventhLine.addChild(createBoardField(BoardFields.RED_BASE_4[0], BoardFields.RED_BASE_4[1]));
