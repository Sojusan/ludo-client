...
void create_board_layout(VerticalLayout layout) {
    ...
    ImageButton yellow_base_1 = new ImageButton("yellow_base_1", "yellow_board_piece.png").layoutWidth(50).layoutHeight(50).padding(Rect(0, 0, 0, 0)).margins(Rect(0, 0, 0, 0));
