...
ImageButton createBoardImageButton(string id, string image) {
    BoardPiece button = new BoardPiece(id, image);
...
void create_board_layout(VerticalLayout layout) {
    ...
    firstLine.addChild(
        new FrameLayout("test")
        .addChild(createBoardImageButton("yellow_base_1", "yellow_board_piece.png"))
        .addChild(createBoardImageButton("yellow_player_1", "yellow_board_piece.png"))
    );
