...
void create_board_layout(VerticalLayout layout) {
    ...
    eighthLine.addChild(createBoardImageButton("gray16", "gray_board_piece.png"));
    // Ninth line
    ...
    ninthLine.addChild(new HSpacer().layoutWidth(50));
    ninthLine.addChild(new HSpacer().layoutWidth(50));
    ninthLine.addChild(createBoardImageButton("gray22", "gray_board_piece.png"));
    ninthLine.addChild(createBoardImageButton("blue_end_2", "blue_board_piece.png"));
    ninthLine.addChild(createBoardImageButton("gray17", "gray_board_piece.png"));
    // Tenth line
    ...
    tenthLine.addChild(new HSpacer().layoutWidth(50));
    tenthLine.addChild(createBoardImageButton("gray21", "gray_board_piece.png"));
    tenthLine.addChild(createBoardImageButton("blue_end_2", "blue_board_piece.png"));
    tenthLine.addChild(createBoardImageButton("gray18", "gray_board_piece.png"));
    tenthLine.addChild(new HSpacer().layoutWidth(50));
    tenthLine.addChild(new HSpacer().layoutWidth(50));
    ...
    eleventhLine.addChild(createBoardImageButton("gray20", "gray_board_piece.png"));
    eleventhLine.addChild(createBoardImageButton("gray19", "gray_board_piece.png"));
    eleventhLine.addChild(new HSpacer().layoutWidth(50));
    eleventhLine.addChild(new HSpacer().layoutWidth(50));
    eleventhLine.addChild(createBoardImageButton("red_base_3", "gray_board_piece.png"));
    eleventhLine.addChild(createBoardImageButton("red_base_4", "gray_board_piece.png"));
