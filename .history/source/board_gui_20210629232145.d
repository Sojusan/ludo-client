...
void create_board_layout(VerticalLayout layout) {
    ...
    fourthLine.addChild(new HSpacer().layoutWidth(50));
    fourthLine.addChild(new HSpacer().layoutWidth(50));
    fourthLine.addChild(createBoardImageButton("gray_35", "gray_board_piece.png"));
    fourthLine.addChild(createBoardImageButton("green_end_2", "green_board_piece.png"));
    fourthLine.addChild(createBoardImageButton("gray_4", "gray_board_piece.png"));
    fourthLine.addChild(
