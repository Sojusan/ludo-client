...
FrameLayout createBoardField(string id, string image) {
    ...
    board_field.addChild(createBoardImageButton(null, image));
    return board_field;
}
...
void create_board_layout(VerticalLayout layout) {
    ...
    FrameLayout test = new FrameLayout("yellow_base_1");
    test.addChild(createBoardImageButton("yellow_base_1", "yellow_board_piece.png"));
    test.addChild(createPlayerPawn("yellow_player_1", "yellow_pawn.png"));
    test.addChild(createPlayerPawn("yellow_player_2", "yellow_pawn.png"));
    firstLine.addChild(new FrameLayout("yellow_base_1").addChild(createBoardImageButton("yellow_base_1", "yellow_board_piece.png")));
