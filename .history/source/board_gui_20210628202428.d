...
void create_board_layout(VerticalLayout layout) {
    ...
    thirdLine.addChild(new HSpacer().layoutWidth(50));
    // Fourth line
    HorizontalLayout fourthLine = new HorizontalLayout("forthLine");
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(
    ...
    forthLine.addChild(new HSpacer().layoutWidth(50));
    // Fifth line
    HorizontalLayout fifthLine = new HorizontalLayout("forthLine");
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
    forthLine.addChild(new HSpacer().layoutWidth(50));
