...
interface LudoClientCallback {
    void onLudoConnect(IRCClient client);
    void onLudoDisconnect(IRCClient client);
    void onLudoMessage(IRCClient client, IRCMessage message);
    void onLudoPing(IRCClient client, string message);
    void onLudoPrivmsg(IRCClient client, IRCAddress source, string target, string message);
    void onLudoNotice(IRCClient client, IRCAddress source, string target, string message);
}
