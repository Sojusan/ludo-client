...
class GameBoard : VerticalLayout {
    ...
    ///
    void addPawn(FrameLayout field, string pawn_id, string image) {
...
class GamePage : HorizontalLayout {
    ...
    void addPlayer(string color) {
        switch (color) {
            case "yellow":
                _gameBoard.addPawn(_gameBoard.findField(BoardFields.YELLOW_BASE_1[0]), BoardPawns.YELLOW_PAWN_1, );
        }
    }
}
