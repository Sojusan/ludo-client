...
class GameBoard : VerticalLayout {
    ...
    this(MenuWidget menu) {
        ...
        Log.i(BoardFields.YELLOW_BASE_1[0] ~ BoardFields.YELLOW_BASE);
    ...
    ///
    void addPawn(FrameLayout field, string id, string image) {
        field.addChild(createPlayerPawn(id, image));
    }

    ///
    void deletePawn(FrameLayout field, string id) {
        field.removeChild(id);
    }
...
class GamePage : HorizontalLayout {
    ...
    void addPlayer(string color) {
        // switch (color) {
        //     case "yellow":
        //         // _gameBoard.addPawn(_gameBoard.findField("yellow_base_1"), "yellow_pawn_1");
        // }
    }
}
