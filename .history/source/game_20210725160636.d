...
class GameWidget : FrameLayout, LudoClientCallback, BoardPiecesCallback {
        ...
        if (a) {
            switch (a.id) {
                ...
                case LudoActions.Ready:
                    ...
                    return true;
                case LudoActions.BoardButtonClicked:
    ...
    void connect() {
        if (!_client) {
            ...
            Log.i("TESTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT 1");
            _gamePage._gameBoard.boardPieces.callback(this);
            Log.i("TESTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT 2");
        }
        _client.connect(
    ...
    ///
    void onBoardPieceClick() {
        Log.i("onBoardPieceClick");
    }
